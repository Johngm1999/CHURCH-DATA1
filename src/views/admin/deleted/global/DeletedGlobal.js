...
import DeletedGlobalData from "./DeletedGlobalDataDisplayForm";
...
function DeletedGlobal() {
    const [page, setPage] = useState(1);
    const [triggerApiCall, setTriggerApiCall] = useState(true);
    const url = `${endpoints.global.deletedGlobal}?page=${page}&limit=10`;
        ...
        restore: ({ row }) => (
            <div style={{ textAlign: "center" }}>
                <DeleteWithWarning
                    ...
                    endpoint={endpoints.global.restoreGlobal}
                />
            </div>
        ),
        delete: ({ row }) => (
            <div style={{ textAlign: "center" }}>
                <DeleteWithWarning
                    ...
                    endpoint={endpoints.global.permanentDelete}
                />
            </div>
        ),
    };
    ...
    return (
        <>
            <PaginatedTable
                ...
                {...viewProps.GlobalDeletedDetails}
