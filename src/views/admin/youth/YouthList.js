...
import YouthComplete from "./YouthComplete"; // Assuming default export
import YouthIncomplete from "./YouthIncomplete"; // Assuming default export
    ...
    return (
        <Box>
            ...
            <Box sx={{ p: 3 }}>
                ...
                {/* Render YouthComplete component for the first tab */}
                {value === 1 && (
                    <YouthIncomplete
                        getIncompleteDataCount={getIncompleteDataCount}
                    />
                )}{" "}
                {/* Render YouthIncomplete component for the second tab */}
            </Box>
        </Box>
    );
}
